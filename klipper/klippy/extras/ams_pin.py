...
class VirtualPinChip:
    ...
    def __init__(self, printer):
        ...
        # dummy command queue implementation
        self._dummy_cq = object()
...
class VirtualInputPin:
    ...
    def __init__(self, printer, name, initial_value=False):
        ...
        self._watchers = []
        self.chip = _ensure_chip(printer)
        self.oid = self.chip.create_oid()
        self.chip.register_pin(self)
