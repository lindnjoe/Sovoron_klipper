...
class OAMSManager:
    ...
    def register_runout_callback(self, callback: Callable[[str, str, int], None]):
        self.runout_callback = callback

    def load_spool_for_lane(self, fps_name: str, group_name: str, oams_name: str, bay_index: int) -> bool:
