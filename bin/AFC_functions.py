...
class afcFunction:
    ...
    def cmd_AFC_LANE_RESET(self, gcmd):
        ...
        # stepper — the filament lives in the unit and only its serial protocol
        # can pull it back. The stepper-move loop below would spin without moving
        # filament and always fail "failed to reset to hub". Delegate to the
        # unit's own reset command (the get_lane_reset_command hook those units
        # already provide) when present.
