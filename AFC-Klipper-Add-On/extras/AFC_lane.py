...
class AFCLane:
    ...
    def __init__(self, config: ConfigWrapper) -> None:
        ...
        # Per-lane overrides for ACE feed/retract parameters (None = use unit default)
        self.feed_length: Optional[float]   = config.getfloat('feed_length', None)        # Override feed_length set at the unit (AFC_ACE) level
        self.retract_length: Optional[float] = config.getfloat('retract_length', None)    # Override retract_length set at the unit (AFC_ACE) level
        self.use_feed_assist: Optional[bool] = config.getboolean('use_feed_assist', None) # Override use_feed_assist set at the unit (AFC_ACE) level
