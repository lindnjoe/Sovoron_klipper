    ...
    def _handle_successful_reload(self, fps_name: str, fps_state: 'FPSState', target_lane: str,
        ...
        if source_lane_name:
            try:
                ...
                # Also explicitly clear AFC hub cache/virtual hub sensor for the source lane.
                # UNSET_LANE_LOADED clears active tool state, but same-FPS transitions can leave
                # stale hub virtual state without this explicit clear.
