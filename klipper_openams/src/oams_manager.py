    ...
    def __init__(self,
        ...
        def _monitor_runout(eventtime):
            ...
            if self.state == OAMSRunoutState.MONITORING:
                ...
                try:
                    path_length = getattr(self.oams[fps_state.current_oams], "ptfe_length", None)
                except Exception:
                    logging.exception("OAMS: Failed to read PTFE length while coasting on %s", self.fps_name)
                    return eventtime + MONITOR_ENCODER_PERIOD
