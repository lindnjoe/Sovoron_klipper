...
class OAMSMonitor:
    ...
    def __init__(self, fps_name, fps_obj, reactor, logger,
                 ...
                 stuck_pressure_low=None, stuck_load_grace=None):
        """
        ...
        :param stuck_pressure_low: Override for stuck spool pressure threshold
        :param stuck_load_grace: Override for stuck spool load grace period
        """
